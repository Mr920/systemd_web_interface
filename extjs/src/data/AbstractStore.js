...
Ext.define('Ext.data.AbstractStore', {
     ...
     * 
     * @localdoc **Note:** In general, this configuration option should only be used for 
     * simple stores like a two-field store of 
    ...
    constructor: function(config) {
         ...
         *
         * For {@link #remoteSort remotely sorted} stores, this will be upon the success 
         * of a load operation triggered by changing the store's sorters.
         *
         * For locally sorted stores, this will be just after the data items in the 
         * store's backing collection are sorted.
