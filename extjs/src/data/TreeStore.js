 ...
 * 
 * #root as a Function
 * You can pass a function as the data reader's root when the tree's dataset has 
 ...
 * 
 * See {@link Ext.data.reader.Reader#root root} for more information.
 */
Ext.define('Ext.data.TreeStore', {
    ...
    setRootNode: function(root, /* private */ preventLoad) {
        ...
        // Ensure old root has no references to this store.
        if (oldRoot) {
            oldRoot.unjoin(me);
        }
