...
Ext.define('Ext.data.Store', {
    ...
    remove: function(records, /* private */ isMove, silent) {
        ...
        // If there are no records to remove, this is a no-op.
        // Return early and do not fire any confusing events.
        if (!length) {
            return;
        }
        ...
        for (; i < length; i++) {
            ...
            if (!isMove && isNotPhantom) {
                ...
                // It doesn't make sense for some stores like NodeStore to keep a cache of removed records.
                if (me.cacheRemovedRecords) {
