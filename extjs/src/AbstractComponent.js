...
Ext.define('Ext.AbstractComponent', {
    ...
    getOverflowStyle: function() {
        ...
        // rolls assignment statements into conditional test value expressions and property object initializers.
    ...
    setSize : function(width, height) {
        ...
        if (me.rendered && me.isVisible()) {
            if (oldWidth !== me.width || oldHeight !== me.height) {
                if (widthIsString || heightIsString) {
    ...
    /**
     * @method
     * @inheritdoc Ext.AbstractComponent#static-resumeLayouts
     * @member Ext
     */
    ...
    /**
     * @method
     * @inheritdoc Ext.AbstractComponent#static-suspendLayouts
     * @member Ext
     */
