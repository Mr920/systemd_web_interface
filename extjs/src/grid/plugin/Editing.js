...
Ext.define('Ext.grid.plugin.Editing', {
    ...
    onCellClick: function(view, cell, colIdx, record, row, rowIdx, e) {
        ...
        if (me.shouldStartEdit(editor) && (!expanderSelector || !e.getTarget(expanderSelector))) {
    ...
    onEnterKey: function(e) {
        ...
        // Returning true will allow the event to propagate. We need to do this for a couple of reasons:
        //   1. The enter key needs to work properly in the textarea, i.e., allow for multi-line text.
        //   2. The enter key must not complete the edit for textareas.
        // See EXTJS-15160 and EXTJS-15880.
        if (me.editing) {
            return true;
        }
     ...
     * @return {Object/undefined} The editing context based upon the passed record and column
     */
