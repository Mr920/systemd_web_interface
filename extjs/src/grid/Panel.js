 ...
 * will load JSON data inline.  In most apps we would be placing the grid inside another 
 * container and wouldn't need to use the {@link #height}, {@link #width} and 
 * {@link #renderTo} configurations but they are included here to make it easy to get up 
 * and running.
 *
 ...
 *
 * **Height config with bufferedRenderer plugin**
 *
 * The {@link #height} config must be set when creating a grid using the 
 * {@link Ext.grid.plugin.BufferedRenderer bufferedRenderer} plugin _and_ the grid's 
 * height is not managed  by an owning container layout.
 *
 * ## Configuring columns
 *
