...
Ext.define('Ext.layout.container.Box', {
    ...
    setChildHeight: function(ownerContext, childContext, height) {
        var names = ownerContext.boxNames,
            margins = childContext.getMarginInfo();
        
        childContext[names.setHeight](height - margins[names.height]);
    },
    ...
    destroy: function() {
        ...
        me.flexSortFn = me.innerCt = me.overflowHandler = null;
        me.callParent(arguments);
    },
