...
Ext.define('Ext.form.field.TextArea', {
    ...
    autoSize: function() {
        ...
        if (me.grow && me.rendered && me.getSizeModel().height.auto) {
            ...
            height = Ext.util.TextMetrics.measure(inputEl, value, inputEl.getWidth(true)).height + inputEl.getPadding('tb');
            height = me.currentHeight = Math.min(Math.max(height, me.growMin), me.growMax);
