...
Ext.define('Ext.form.field.Text', {
    ...
    onFocus: function() {
        ...
        // Cell editing sets the delayed focus task in onEditComplete to refocus the gridview
        // in 100ms.  We need to cancel that now.
        //
        // Obviously not a complete fix, but since the focus improvements didn't come until 5.1
        // this will benefit most cases where the gridview stealing the focus back is most
        // apparent and egregious.
        // See EXTJS-10529.
        me.getFocusTask().cancel();
