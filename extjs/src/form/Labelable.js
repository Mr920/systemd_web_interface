...
Ext.define("Ext.form.Labelable", {
    ...
    labelableRenderTpl: [
        ...
        '<tr role="presentation" id="{id}-inputRow" <tpl if="inFormLayout">id="{id}"</tpl> class="{inputRowCls}">',
            ...
            '<tpl elseif="msgTarget==\'under\'">',
                '<div role="alert" aria-live="polite" id="{id}-errorEl" class="{errorMsgCls}" colspan="2" style="display:none"></div>',
                '{afterBodyEl}',
                '</td>',
            '</tpl>',
        '</tr>',
    ...
    getLabelStyle: function () {
        ...
        if (me.labelAlign !== 'top') {
            ...
            // For a top labelAlign give the labelPad a bottom margin.
