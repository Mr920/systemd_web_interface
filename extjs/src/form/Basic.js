...
Ext.define('Ext.form.Basic', {
     ...
     * The errors param may be in one of two forms: Object[], Object, or 
     * {@link Ext.data.Errors} instance
     * 
     ...
     *     });
     * 
     * - **Ext.data.Errors:** An Ext.data.Errors instance with a hash of field 
     * / message objects (or an array of multiple objects).
     * 
     * Example Ext.data.Errors syntax:
     * 
     *     var errors = new Ext.data.Errors();
     *     // SINGLE ERROR MESSAGE
     *      errors.add({field: 'name', message: 'Name invalid message'});
     *     
     *     // MULTIPLE ERROR MESSAGES
     *     errors.add({field: 'name', message: ['First message', 'Second message']});
