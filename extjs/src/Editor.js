    ...
    */
    ...
    startEdit: function (el, value) {
        ...
        if (me.fireEvent('beforestartedit', me, me.boundEl, value) !== false) {
            ...
            me.realign(true);
            field.focus(field.selectOnFocus ? true : [field.getRawValue().length]);
    ...
    // private
    onEndEdit: function (remainVisible) {
        var me = this,
            field = me.field;
        ...
        // Fields which mimic blur have to be told to fire their blur events.
