 ...
 *
 * This Panel itself may be a child item of, for example, a {@link Ext.tab.Panel} which will size its child items to fit
...
Ext.define('Ext.panel.Panel', {
    ...
    initComponent: function() {
        ...
        me.addEvents(
             ...
             * its header. Only applicable when the Panel is an item in a
             * {@link Ext.layout.container.Border Border Layout}.
             */
            'float',
            ...
            /**
             * @event unfloat
             * Fires after a "floated" Panel has returned to its collapsed state
    ...
    initDraggable : function() {
        ...
        // For DD package aware dragging of Panels
             ...
             *
             * This object fires various events during its life cycle and during a drag operation.
             *
