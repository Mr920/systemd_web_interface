    ...
    return {
        ...
        tap: function (className, methodName) {
            var me = this,
                ...
                klass, statik, i, parts, length, name, src, start,
                tapFunc;
            ...
            tapFunc = function(){
                if (typeof className == 'string') {
                    ...
                    start = 0;
                    // if an ext class was specified, we need to pick up the sandboxed
                    // Ext reference, so don't use Ext.global as the starting point, as
                    // we'd pick up Ext3 as the Ext reference then
                    if(parts[0] == 'Ext') {
                        start = 1;
                        klass = Ext;
                    }
